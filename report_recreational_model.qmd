...
source(here::here("functions_report.R"))

water <- terra::rast(here::here("bush_example", "original", "Water.tif"))

slsra <- terra::rast(here::here("bush_example", "SLSRA.tif"))

fips_n <- terra::rast(here::here("bush_example", "FIPS_N.tif"))

fips_i <- terra::rast(here::here("bush_example","original", "FIPS_I.tif"))
...
soft_recr <- 
  read.csv(here::here("bush_example", "presets.csv"))%>%
...
```{r, echo=FALSE}
slsra_variables <- 
  read.csv(here::here("bush_example", "config.csv"))%>%
...
fips_i_rstack <- list(
  "original" = fips_i,
  "distance" = terra::rast(here::here("bush_example", "dist", "FIPS_I_dist.tif")),
  "scored" = terra::rast(here::here("bush_example", "FIPS_I.tif"))
  )
...
```{r, echo=FALSE}
water_variables <- read.csv(here::here("bush_example", "config.csv")) %>%
...
water_rstack <- list(
  "original" = water,
  "distance" = terra::rast(here::here("bush_example", "dist", "Water_dist.tif")),
  "scored" = terra::rast(here::here("bush_example", "Water.tif"))
  )
