...
The RP component and the biodiversity component [@rolph2025biodiversity] are distinct models that have been developed independently of each other. However, in both cases their outputs can be displayed on an interactive map of Scotland and served to users using an app framework such as [R Shiny](https://shiny.posit.co/).
...
A retrospective look at the CES part of the BioDT project will be published shortly under @Rolph2025 and @rolph2025biodiversity.
