...
![Recreational Potential (RP) for the whole of Scotland using the two persona presets: hard recreationlaist and soft recreationalist.](images/RP_Scotland_figure.png){#fig_scotland_RP fig-align="center"}
