...
We wish to acknowledge contributors to previous versions of the Recreational Potential model. Will Bolton contributed substantially to the first version of the code written in `R`. ==Megan Williams?==

JMR would like to thank Tomáš Martinovič for assisting with understanding the requirements BioDT.
