...
We use `terra::classify` to quantise this continuous range into six categories according to their steepness (expressed in degrees), this was based on the six classification slopes (expressed in percentage) of @Dick2022.
...
: Example Reclassification of the Water component (river layers) based on @os2023rivers. <a href="data/Rivers_Raw.csv" download>Download the full table (csv) </a>. {#tbl-rivers}
