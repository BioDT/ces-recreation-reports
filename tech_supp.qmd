...
All 87 layers listed in @sec-listitems.
...
- **Extent**: $(x_\text{min}, x_\text{max}, y_\text{min}, y_\text{max}) = (-10000, 660000, 460000, 1220000)$ (a rectangular box around Scotland).
