...
-   Landform features (16 features): The landform data was extracted from the Scotland 250K Soils Map. [@hutton2022soil]. The following methodologies were applied:
    ...
    2.  Grouping: the 334 landform types were manually grouped into 16 broader categories based on descriptive keywords (e.g. “hills”, “foothills” etc…) see ([Appendix I: Groups of landform features]).
...
-   Soil features (2 features): The landform data was derived from the Scotland 250K Soils Map [@hutton2022soil] The following methodology was applied:
    ...
    2.  Grouping: The values were manually aggregated into two soil classes: organic (peat) and mineral based on the original classifications (see [Appendix II: Groups Soil features]).
...
-   Rivers (6 features): The river data was sourced from the Os Open Rivers [@os2023rivers] and the OS Boundaries dataset. The following methodology was applied:
    ...
    3.  Reclassification: To simplify the river data at a national scale, a reclassification was carried out (see [Appendix III: Reclassification rivers and lakes] for examples). This is a subjective and based on:  the “form” attribute (indicating water type), or keywords searches in the “name” field, and researcher knowledge of major rivers of national and regional importance.
...
-   Lakes (7 features): The lakes data was sourced from the Spatial inventory of UK waterbodies dataset [@taylor2021waterbodies]. The following methodology was applied:
    ...
    1.  Reclassification: The dataset contained 25404 features for Scotland. To make it into a relevant and scorable dataset it was reduced to six features based on the given size (in hectares) of a waterbody using the attribute “Poly_Area_Ha” (see [Appendix III: Reclassification rivers and lakes]).
...
This six categories, adapted from @Dick2022 (see Table below)
...
## Appendix I: Groups of landform features
...
## Appendix II: Groups Soil features
...
## Appendix III: Reclassification rivers and lakes
