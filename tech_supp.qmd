...
table <- table[, c(1:4, 6:ncol(table), 5)]
...
The Landscape component raster consists of 40 layers, each representing one of its features (see [List of items/features] for full list)
