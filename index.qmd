...
authors:
  ...
  - name: Jan Dick
    orcid: 0000-0002-4180-9338
  - name: Simon Rolph
    orcid: 0000-0001-6755-9456
...
The main [Summary](summary.html) provides a high-level overview of the Recreational Model and the research context in which it came about. 
...
The [Worked Example](example.html) demonstrates basic usage of the code.
